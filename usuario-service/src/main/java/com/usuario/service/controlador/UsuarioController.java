...
public class UsuarioController {
	...
	private ResponseEntity<List<Carro>> fallBackGetCarros(@PathVariable("usuarioId") int id,
		...
		return new ResponseEntity("El usuario " + id + " tiene los carros en el tayer", HttpStatus.OK);
	}
	...
	private ResponseEntity<List<Moto>> fallBackGetMotos(@PathVariable("usuarioId") int id, RuntimeException exception) {
		return new ResponseEntity("El usuario " + id + " tiene las motos en el tayer", HttpStatus.OK);
	}
	...
	private ResponseEntity<List<Carro>> fallBackGetTodos(@PathVariable("usuarioId") int id,
			RuntimeException exception) {
		return new ResponseEntity("El usuario " + id + " tiene los vehiculos", HttpStatus.OK);
	}
